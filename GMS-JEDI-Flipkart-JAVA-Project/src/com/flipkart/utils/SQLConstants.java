...
public class SQLConstants {
    public static final String SQL_INSERT_GYM_DETAILS_QUERY = "insert into GymCentre (gymOwnerEmail, name, address, totalArea, numItem, numSeatsPerSlot, isApproved) values(?, ?, ?, ?, ?, ?, ?)";
